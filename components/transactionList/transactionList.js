    ...
    if (props.uid != null) {
        ...
        const deleteTransaction = async (id) => {
            await firebase
                ...
                .delete()
                .then(function () {
                    alert("Transakce úspěšně smazána!");
                })
                .catch(function (error) {
                    alert("Chyba při mazání transakce: ", error);
                    console.log("Chyba při mazání transakce: ", error);
                });
        };
                            ...
                            return (
                                <li className={styles.transaction} key={dateId}>
                                    ...
                                    <div className={styles.transactionBottom}>
                                        <ul>
                                            {transaction.type == "Výdaj" ? (
                                                <li>{transaction.amount} Kč</li>
                                            ) : (
                                                <li>{transaction.amount} Kč</li>
                                            )}
